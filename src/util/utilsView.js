        ...
        return (
            ...
            >
                <View style={[styles.setting_item_container]}>
                    ...
                    <Image
                        source = {expandableIco ? expandableIco : GlobalIcons.icon_arrow_left}
    ...
    static getLeftButton = (callBack) => {
        return (
            <TouchableOpacity
                ...
                onPress = {callBack}
            >
                <Image style={styles.leftButtonIcon} source={GlobalIcons.icon_arrow_left}/>
            </TouchableOpacity>
        )
    }
    ...
    static getMoreButton = (callBack) => {
        return (
            ...
            >
                ...
                <Image style={styles.moreMenuBtnIcon} source={GlobalIcons.icon_arrow_left} />
                </View>
            </TouchableHighlight>
        )
    }
    ...
    static getShareButton = (callBack) => {
        return (
            <TouchableHighlight
                ...
                underlayColor = {'transparent'}
            >
                <Image style={styles.shareBtnIcon} source={GlobalIcons.icon_arrow_left}/>
            </TouchableHighlight>
        )
    }
}
